...
[![CI](https://github.com/cecilkootz/hassos-addons/actions/workflows/main.yml/badge.svg)](https://github.com/cecilkootz/hassos-addons/actions/workflows/main.yml)
...
1. Add my [repository](https://github.com/cecilkootz/hassos-addons). The URL is `https://github.com/cecilkootz/hassos-addons`.
...
- [Cecilkootz](https://github.com/cecilkootz)
...
- [x] Add TLS
- [ ] Per [this comment](https://community.home-assistant.io/t/hello-world-example-addon-from-developer-docs-stopped-working-s6-overlay-issue/421486/7), setup container images on a registry (DockerHub or GitHub) so that users aren't building the container with each install (would have prevented [this issue](https://github.com/cecilkootz/hassos-addons/issues/2))
